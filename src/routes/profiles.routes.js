...
import { listProfilesQuerySchema, updateOwnProfileSchema, pinBadgeSchema, profileIdParamSchema } from "../validators/profiles.validators.js";
...
profilesRouter.get("/:id", validate(profileIdParamSchema, "params"), getPublicProfile);
