...
// lives in their own transaction history, not a cash-out-able balance. An
// impersonated session can't reach this anyway — guard.js blocks every
// non-GET request while impersonating.
